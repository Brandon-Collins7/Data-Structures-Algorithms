package CompFund2.Module7.PracticeLabTest3;
...
public class BSTContains {
    ...
    static class BinarySearchTree<T extends Comparable<T>> {
        ...
        public boolean contains(T value){
            ...
            return containsRec(n, value);
        }
        public boolean containsRec(Node n, T value) {
            if(value.compareTo(n.element) == 0){
                return true;
            }
            else if(value.compareTo(n.element) > 0 && n.right != null){
                n = n.right;
                return containsRec(n, value);
            }
            else if(value.compareTo(n.element) < 0 && n.left != null){
                n = n.left;
                return containsRec(n, value);
            }    
            return false;
